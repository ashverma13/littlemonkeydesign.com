		...
		<fieldset>
			...
			<div class="tab-content">
				<div class="tab-pane active" id="editor">
					...
					<?php if ($this->form->getLabel('jcontent_type', 'metadata')): ?>
					<div class="control-group">
						<div class="control-label">
							<?php echo $this->form->getLabel('jcontent_type', 'metadata'); ?>
						</div>
						<div class="controls">
							<?php echo $this->form->getInput('jcontent_type', 'metadata'); ?>
						</div>
					</div>
					<?php endif ?>

					<?php if ($this->form->getLabel('jcontent_animate', 'metadata')): ?>
					<div class="control-group">
						<div class="control-label">
							<?php echo $this->form->getLabel('jcontent_animate', 'metadata'); ?>
						</div>
						<div class="controls">
							<?php echo $this->form->getInput('jcontent_animate', 'metadata'); ?>
						</div>
					</div>
					<?php endif ?>

					<?php if ($this->form->getLabel('jcontent_size', 'metadata')): ?>
					<div class="control-group">
						<div class="control-label">
							<?php echo $this->form->getLabel('jcontent_size', 'metadata'); ?>
						</div>
						<div class="controls">
							<?php echo $this->form->getInput('jcontent_size', 'metadata'); ?>
						</div>
					</div>
					<?php endif ?>
