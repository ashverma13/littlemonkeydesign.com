...
<div class="item-page<?php echo $this->pageclass_sfx?> clearfix">
	...
	<?php if (!$input->get('fixelpopup', 0) && !empty($this->item->pagination) && $this->item->pagination && !$this->item->paginationposition && $this->item->paginationrelative) : ?>
	...
	<article>
		...
		<?php if ($params->get('access-view')):?>
			...
			<?php
			if (!$input->get('fixelpopup', 0) && !empty($this->item->pagination) AND $this->item->pagination AND !$this->item->paginationposition AND !$this->item->paginationrelative):
			...
			<section class="article-content clearfix" >
				...
				<?php if(preg_match_all('#<img[^>]+>#iU', $this->item->text, $imgs)) : ?>
					...
					if($total > 0) : ?>
						...
						<div id="fixel-carousel-<?php echo $this->item->id ?>" class="carousel slide">
							<ol class="carousel-indicators">
							<?php for($i = 0; $i < $total; $i++) : ?>
								<li data-target="#fixel-carousel-<?php echo $this->item->id ?>" data-slide-to="<?php echo $i ?>"<?php echo ($i == 0 ? ' class="active"' : '') ?>></li>
							<?php endfor; ?>
							</ol>
							<div class="carousel-inner">
								...
								foreach($img_data as $img => $attr) : ?>
									...
									<div class="item<?php echo ($j == 0 ? ' active' : '') ?>">
										...
										<?php if((isset($attr['alt']) && $attr['alt']) || (isset($attr['title']) && $attr['title'])) : ?>
							...
							<a class="carousel-control left" href="#fixel-carousel-<?php echo $this->item->id ?>" data-slide="prev">&lsaquo;</a>
							<a class="carousel-control right" href="#fixel-carousel-<?php echo $this->item->id ?>" data-slide="next">&rsaquo;</a>
						</div>
						...
						<script type="text/javascript">
							(function($){
								$(document).ready(function($){
									$('#fixel-carousel-<?php echo $this->item->id ?>')
										.carousel()
										.on('slid', function(){
											
											$('#fixel-carousel-<?php echo $this->item->id ?>-thumbnails')
				...
				<?php
					if (!$input->get('fixelpopup', 0) && !empty($this->item->pagination) && $this->item->pagination && $this->item->paginationposition && !$this->item->paginationrelative): ?>
						<?php
