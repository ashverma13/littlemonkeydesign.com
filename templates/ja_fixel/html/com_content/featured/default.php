...
<div class="fixel-grid-wrapper">
	<div id="fixel-grid" class="fixel-grid blog-featured<?php echo $this->pageclass_sfx;?> clearfix">

	<?php

		$items = !empty($this->lead_items) ? $this->lead_items : array();
		if(!empty($this->intro_items)){
			$items = array_merge($items, $this->intro_items);
		}
