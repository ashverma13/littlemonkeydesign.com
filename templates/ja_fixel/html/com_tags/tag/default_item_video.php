...
if (!empty($images->image_intro)) {
	...
	$vsrc        = FixelHelper::video($this->core_item);
...
<div class="item-video-wrap">
	...
	<div class="item-image">
		<?php if ($link): ?>
		<a class="video-link" href="<?php echo $link; ?>" title="<?php echo $this->escape($this->core_item->core_title); ?>">
		<?php endif; ?>
    ...
    <div class="item-desc">
        <h2 class="article-title">
            <?php if ($link) : ?>
                <a class="video-link" href="<?php echo $link; ?>"> <?php echo $this->escape($this->core_item->core_title); ?></a>
            <?php else : ?>
