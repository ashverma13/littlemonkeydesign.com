...
<?php
  ...
  $layout_config = json_decode ('{
    ...
    "one_sidebar1": {
      "default" : [ "span9 has-sidebar1 pull-right"         , "span3"             ],
      "wide"    : [],
      "xtablet" : [ "span8 pull-right has-sidebar1"         , "span4"             ],
      "tablet"  : [ "span12"        , "span12 spanfirst"  ]
    },
    "one_sidebar2": {
      "default" : [ "span9 has-sidebar2"         , "span3"             ],
      "wide"    : [],
      "xtablet" : [ "span8 has-sidebar2"         , "span4"             ],
      "tablet"  : [ "span12"        , "span12 spanfirst"  ]
    },
    "no_sidebar": {
      "default" : [ "span12" ]
